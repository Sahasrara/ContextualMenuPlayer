...
namespace ContextualMenuPlayer.Test
{
    public class ContextualMenuDataNodeTests
    {
        ...
        {
            ContextualMenuNodeData rootNode = GenerateSingleActionNoopTree("Double Slash Test//");
            Assert.AreEqual(1, CountChildren(rootNode));
        ...
        public void AllStatuses()
        {
            ...
            // Construct Menu Data
            ContextualMenuNodeData rootNode = ContextualMenuNodeData.ConstructMenuTree(testMenu);
        ...
        public void ALittleOfEverything()
        {
            ...
            testMenu.AppendSeparator();
            testMenu.AppendAction(
                $"Nested Deep 0/Nested Deep 1/Nested Deep 2/Nested Deep 3",
                NoOpMenuAction,
                DropdownMenuAction.AlwaysEnabled
            );
            testMenu.AppendAction(
                $"Nested Deep 0/Option 1",
                NoOpMenuAction,
                DropdownMenuAction.AlwaysEnabled
            );
            testMenu.AppendAction(
                $"Nested Deep 0/Nested Disabled",
                NoOpMenuAction,
